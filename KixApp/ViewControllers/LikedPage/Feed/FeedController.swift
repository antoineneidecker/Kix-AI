...
class FeedController: LBTAListHeaderController<RecentMessageCell, RecentMessage, Header>, UICollectionViewDelegateFlowLayout, CardViewDelegateMoreInfo, likedControllerHeaderDelegate{
...
//        hstack(textView, sendButton.withSize(.init(width: 60, height: 60)), alignment: .center).withMargins(.init(top: 0, left: 16, bottom: 0, right: 16))
    ...
    func didChangeToFeedView() {
        print(collectionView.superview)
...
//        isRackView = true
    ...
    fileprivate func setupUI() {
        ...
        customNavBar.isRackViewMeta = false
